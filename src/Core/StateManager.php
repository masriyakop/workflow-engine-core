...
class StateManager
{
    ...
    /**
     * Clear completion for a step so it can be re-executed.
     */
    public function unmarkStepCompleted(WorkflowInstance $instance, string $stepId): void
    {
        $instance->removeCompletedStep($stepId);
        $this->save($instance);
    }
