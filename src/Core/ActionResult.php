...
final class ActionResult
{
     ...
     * @param array<string, mixed> $data Result data for successful / waiting actions
     * @param array<string, mixed> $metadata Additional context and debugging information
     * @param bool $waiting Whether the action is paused waiting for external input
     */
    ...
    {
        return new self(true, null, $data, $metadata, false);
    }
    ...
    {
        return new self(false, $errorMessage, [], $metadata, false);
    }

    /**
     * Create a waiting action result (human / external gate).
     *
     * The step is not completed; the workflow enters WAITING until
     * WorkflowEngine::completeHumanTask() (or equivalent) resumes it.
     *
     * @param array<string, mixed> $data Assignment / wait payload
     * @param array<string, mixed> $metadata Additional context
     */
    public static function waiting(array $data = [], array $metadata = []): static
    {
        return new self(false, null, $data, $metadata, true);
    }
    ...
    {
        return $this->success && ! $this->waiting;
    }

    /**
     * Check if the action is waiting for external input.
     */
